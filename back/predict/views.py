...
# from rest_framework.decorators import api_view, permission_classesk
...
def test_model(stock_data, dates, today):
    ...
    plt.show()    
    return train_data, r2, split_date
...
# @api_view(['GET'])
def get_predict(request, ticker_code):
    ...
    train_data, r2, split_date=test_model(stock_data, dates, today)
